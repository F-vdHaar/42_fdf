...
/*   Updated: 2025/03/12 13:44:24 by fvon-de          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_cols(t_map *map, char *line)
{
	char	**tab;
	char	*temp;
	int		i;
